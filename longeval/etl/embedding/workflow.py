...
class ProcessSentenceTransformer(luigi.Task):
    ...
    def run(self):
        kwargs = {"spark.sql.shuffle.partitions": max(self.num_partitions, 200)}
...
def main(
    ...
    sample_id: Annotated[int, typer.Argument(help="Sample ID")] = None,
    num_sample_ids: Annotated[int, typer.Argument(help="Number of sample IDs")] = 20,
    model_name: Annotated[str, typer.Argument(help="Model name")] = "all-MiniLM-L6-v2",
