...
def create_lda_model(spark, docs, output_path):
    ...
    generatePcaGraph(lda_model, vectorized_docs, output_path, k)
    generateTsneGraph(lda_model, vectorized_docs, output_path, k)
...
class CreateLDAModel(luigi.Task):
    ...
    def run(self):
        with spark_resource() as spark:
            ...
            create_lda_model(spark, docs, self.output_path)
...
class Workflow(luigi.Task):
    ...
    def requires(self):
        return CreateLDAModel(input_path=self.input_path, output_path=self.output_path)
